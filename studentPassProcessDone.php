...
$bus_s_no = $_SESSION['bus2'];
$chkpost = $_SESSION['cpost2'];
$chkdate = $_SESSION['cdate2'];


$sql = "SELECT * FROM seatcheck WHERE bus_serial_no = '$bus_s_no' AND date = '$chkdate' AND check_post = '$chkpost' ";
...
<div class="divH">
	...
	<label class="l1">Bus serial no : <?php echo "$db_bserialno"; ?>
	 ...
	 <label>Student : <?php echo "$db_student"; ?>
	 </label>
